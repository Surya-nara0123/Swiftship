      ...
      54232: function (e, n, t) {
        ...
        var u = {
          ...
          l = {
            ...
            handles: ["paytm", "ptsbi", "pthdfc", "ptaxis", "ptyes"],
          },
          m = {
  ...
  (t.n = function (e) {
    ...
    (function () {
      ...
      function G() {
        ...
        return H(t, n, ["checkoutjs", "hosted"].includes((0, F.AP)("library")));
      }
      var Y = t(84679),
        W = t(44988);
      (0, t(86927).c)(null);
            ...
            "visualViewport" in t.g &&
              (r =
                null !==
                  ...
                  ? e
                  : r);
            (Fe.container.style.position = r < 450 ? "absolute" : "fixed"),
      ...
      Fe.prototype = {
        ...
        openRzp: function (e) {
          this.isOpen = !0;
          var n = ie.setStyles(this.el, { width: "100%", height: "100%" }),
            t = e.get("parent");
          ...
          Ae ||
            ...
            e !== this.rzp &&
              (ie.parent(n) !== r && ie.append(r, n), (this.rzp = e)),
            this.rzp &&
              setTimeout(function () {
            ...
            t
              ? (ie.setStyle(n, "minHeight", "530px"), (this.embedded = !0))
        ...
        onload: function (e) {
          if (
            ...
            if (t && !r) return;
            this.postMessage(n),
              null === (i = me.parentNode) || void 0 === i || i.removeChild(me);
          }
          var i;
        },
        onfocus: function () {
      ...
      function Je(e) {
        return function n() {
          return Ge ? e.call(this) : (setTimeout(n.bind(this), 99), this);
        };
      }
      !(function e() {
        (Ge = document.body || document.getElementsByTagName("body")[0]) ||
          setTimeout(e, 99);
      })(),
        (function () {
          try {
            ...
            var n =
              null === (e = J.ZP.getPluginState(Ve.B.LUMBERJACK_PLUGIN)) ||
              void 0 === e
                ? void 0
                : e.config;
            null == n || n.pause();
        ...
        (0, F.P_)(function (e, n) {
          try {
            if (n.pauseTracking && !e.pauseTracking) {
              var t,
                r =
                  null === (t = J.ZP.getPluginState(Ve.B.LUMBERJACK_PLUGIN)) ||
                  void 0 === t
                    ? void 0
                    : t.config;
              null == r || r.resume();
      ...
      function un() {
        if (!tn) {
          var e;
          (tn = new Fe()), (ze.Z.iframeReference = tn.el), ze.Z.setId(D.fQ.id);
      ...
      (Xe.onNew = function (e, n) {
        ...
        (Xe.open = Je(function () {
            ...
            var e,
              ...
              r =
                ...
                void 0 === n
                  ? void 0
                  : n.getAttribute("lang");
            this.metadata = { isBrave: an, isPrivate: cn, language: r };
          }
          ...
          return (
            ...
            D.zW.setMeta(Ye, (0, B.HUG)() && !(0, B.RlS)("order_id")),
        ...
        fn = Je(function () {
          D.zW.setMeta(D.$J.IS_MOBILE, (0, I.isMobile)()),
            ...
            mn.test(location.host) ||
              (window.Intl ? (tn = un()) : D.zW.Track(D.pz.INTL_MISSING)),
