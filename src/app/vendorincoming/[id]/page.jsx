...
export default function Page({ params }) {
  ...
  const getOrders = async () => {
    ...
    res = await fetch(
      "https://swiftshipbackend-production.up.railway.app/getordersbyrestaurant",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const updateOrders = async (status) => {
    ...
    let res = await fetch(
      "https://swiftshipbackend-production.up.railway.app/updateorderstatus",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
